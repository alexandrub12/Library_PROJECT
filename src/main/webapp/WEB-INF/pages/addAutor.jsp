    ...
    <form class="needs-validation" novalidate method="post" action="${pageContext.request.contextPath}/AddAutor">
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="nume_autor" name="nume_autor" placeholder="" value="" required>
                <div class="invalid-feedback">
                    Nume Autor is required.
                </div>
                <label for="prenume_autor">Prenume Autor</label>
                <input type="text" class="form-control" id="prenume_autor" name="prenume_autor" placeholder="" value="" required>
                <div class="invalid-feedback">
